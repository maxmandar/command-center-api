...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("apps.guardian.services.CustomTokenBackend",),
...
ROOT_URLCONF = "rocket_service.urls"
...
WSGI_APPLICATION = "rocket_service.wsgi.application"
